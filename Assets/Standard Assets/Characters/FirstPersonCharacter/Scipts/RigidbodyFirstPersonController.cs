...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        public enum ActivePower { none, speed, superJump, doubleJump };
        ...
        private int jumps, startJumps;
        private float startSpeedF, startSpeedB, startSpeedS, startJump, powerTime;
        ...
        private void Start()
        {
            ...
            jumps = 0;
            startJumps = movementSettings.MaxJumps;
            startSpeedF = movementSettings.ForwardSpeed;
            startSpeedB = movementSettings.BackwardSpeed;
            startSpeedS = movementSettings.StrafeSpeed;
            startJump = movementSettings.JumpForce;

            foreach(AudioSource sound in GetComponents<AudioSource>())
            {
                if (sound.clip.name == "launch")
                    jumpSound = sound;
                break;
            }
        }
        ...
        private void FixedUpdate()
        {
            ...
            else if (m_Jumping && jumps < movementSettings.MaxJumps)
            {
                if (m_Jump)
                {
                    Jump();
